/**
 * KnowledgeGraph.ts
 * Description: In-memory intelligence node association matrix
 * Part of CorvusX: Intelligence in the Shadows
 * Generated on: 2026-05-31T17:59:22.791Z
 */
...
export class KnowledgeGraphManager extends EventEmitter {
  ...
  public getState(): KnowledgeGraphState {
    return { ...this.state };
  }

  private log(msg: string): void {
    const formatted = `[${new Date().toISOString()}] [KnowledgeGraph] ${msg}`;
