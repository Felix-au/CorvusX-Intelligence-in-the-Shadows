...
const ModelSelector: React.FC<ModelSelectorProps> = ({
  ...
  const toggleSection = (section: 'ai' | 'audio' | 'ui') => {
  ...
  return (
    <div className="p-4 liquid-glass rounded-lg border border-black/10 dark:border-white/20 space-y-4 text-left">
      <div className="flex items-center justify-between pb-2 border-b border-black/10 dark:border-white/10">
        <h3 className="text-xs font-bold text-primary tracking-wider uppercase">AI Settings</h3>
      ...
      <div style={{ maxHeight: `${maxHeight}px` }} className="overflow-y-auto pr-1.5 space-y-3 scrollbar-thin scrollbar-thumb-gray-700">
        ...
        <div className="border border-black/10 dark:border-white/10 rounded-lg overflow-hidden">
          <button
            ...
            className="w-full flex justify-between items-center px-3 py-2 bg-black/10 dark:bg-white/5 text-[11px] font-bold text-primary cursor-pointer hover:bg-black/15 dark:hover:bg-white/10 transition-colors"
          >
            <span>☁️ AI Provider & Model</span>
            {activeSection === 'ai' ? <ChevronUp className="w-3.5 h-3.5 text-muted" /> : <ChevronDown className="w-3.5 h-3.5 text-muted" />}
          </button>
        ...
        <div className="border border-black/10 dark:border-white/10 rounded-lg overflow-hidden">
          ...
          >
            ...
            {activeSection === 'audio' ? <ChevronUp className="w-3.5 h-3.5 text-muted" /> : <ChevronDown className="w-3.5 h-3.5 text-muted" />}
          </button>
        ...
        {/* Accordion 3: Visual & Onboarding Settings */}
        <div className="border border-black/10 dark:border-white/10 rounded-lg overflow-hidden">
          <button
            type="button"
          ...
          >
            ...
            {activeSection === 'ui' ? <ChevronUp className="w-3.5 h-3.5 text-muted" /> : <ChevronDown className="w-3.5 h-3.5 text-muted" />}
          </button>
