...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  onSimulateLatestResponse: (callback: () => void) => {
    const subscription = () => callback()
  ...
  testLlmConnection: (apiKey?: string, model?: string) => ipcRenderer.invoke("test-llm-connection", apiKey, model),
  getLlmMode: () => ipcRenderer.invoke("get-llm-mode"),
  setLlmMode: (mode: 'code' | 'general') => ipcRenderer.invoke("set-llm-mode", mode),
